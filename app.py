...
def analyze_news_with_gpt(recent_news):
    ...
    prompt = (
        ...
        f"2. 제공된 5건의 뉴스 중 '개인정보 유출', '데이터 침해(Data Breach)'등 '유출 사고'와 가장 관련이 깊은 기사 1개를 선정해서 그 기사의 제목과 핵심 요약(70자 내외)을 적어줘. 만약 관련 기사가 전혀 없다면 가장 위험도가 높은 기사를 선정해줘.\n\n"
...
def get_dashboard_data(db: Session = Depends(get_db)):
    ...
    # 3. 오른쪽 두번째: 무작위 과거 CVE 1건 추출 (PostgreSQL RANDOM 함수 사용)
